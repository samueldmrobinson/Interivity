...
<section class="wrap">
    ...
    <div class="stream-cc">
        <h4 style="border-top: 2px solid #232323;
            border-bottom: 1px dotted #232323;"><?php echo ucfirst($this->brwsedta); ?></h4>
        <div class='accordionButton first'>Filter (<?php echo ucfirst($this->brwsedta); ?>)</div>
        <?php
        if ($this->brwsedta == 'cities') {
