        ...
        <article>
            <div class="post">                     
                <div class="article-content">                     
                    ...
                    <div class="clear"></div>
                      <div class='accordionButton1 first'> Are You Still Having Problems?</div>
                <div class='accordionContent'> 
                  <ul class="tags">
                    ...
                    <div id="respond">
                        ...
                        <form action="<?php echo URL; ?>login/checkpoint" method="post" id="commentform">


                            <div class="scenter">
                                <label for="email">Your SME Number:<span>*</span></label> 
                                <input id="email" name="minter_email" type="text" value="" size="50" />
                               
                                <label for="email">First Name:<span>*</span></label> 
                                <input id="email" name="minter_firstname" type="text" value="" size="50" />
                                
                                <label for="email">Last Name:<span>*</span></label> 
                                <input id="email" name="minter_lastname" type="text" value="" size="50" />
